...
const HOLE_COLORS = { 1: '#3D7BE8', 2: '#29B8C9', 3: '#2EC27E', 4: '#F2742C', 5: '#E2484A' }
...
/* ------------------------------------------------------------------ */
/*  TOP TAHTASI — zarın görsel alternatifi (dikine 5 delik)            */
/* ------------------------------------------------------------------ */

function BallBoard({ holes, value, tick, auto, disabled, done, onThrow }) {
